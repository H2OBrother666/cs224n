...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.decoder = nn.LSTMCell(self.hidden_size + embed_size,hidden_size)
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        for target_word in Y:
            Ybar_t = torch.cat((target_word,o_prev),1)
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        batch_size,hidden_size = dec_hidden.shape
        src_len = enc_hiddens.shape [1]
        #print('batch_size: %d ,hidden_size: %d , src_len: %d ' % (batch_size,hidden_size,src_len))
        e_t = torch.bmm(enc_hiddens_proj,dec_hidden.view((dec_hidden.shape[0],dec_hidden.shape[1],1)))
        e_t = e_t.view(batch_size,src_len)
        ### END YOUR CODE
        ...
        a_t      = torch.bmm(enc_hiddens.transpose(1,2),alpha_t.view(batch_size,src_len,1))
        ...
        combined_output = O_t
        #print(dec_state[0].shape,dec_state[1].shape, combined_output.shape, e_t.shape)
