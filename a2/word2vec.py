...
def naiveSoftmaxLossAndGradient(
    ...
    #out_aff ,cache_aff = affine_forward(centerWordVec.reshape(1,-1), outsideVectors.transpose(), 0)
    ...
    if gradCenterVec.shape != centerWordVec.shape:
        print('centerWordVec wrong shape')
        print(gradCenterVec.shape)
        print('correct shape')
        print(centerWordVec.shape)
    if gradOutsideVecs.shape != outsideVectors.shape:
        print('gradOutsideVecs wrong shape')
